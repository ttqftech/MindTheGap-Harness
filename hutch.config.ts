export default {
	...
	scripts: {
		...
		//   pnpm exec vite --port 5173  → Vite 开发服务器，提供前端 HMR
		...
		dev: ["pnpm", "exec", "concurrently", "pnpm exec vite --port 5173", "hutch electrobun dev --watch"],

		// 构建 + 启动（无 HMR，用于调试或预览生产产物）
		start: "pnpm exec vite build && hutch electrobun dev",
